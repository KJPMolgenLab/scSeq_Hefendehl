...
variables=c("Celltype","Sex", "Age","Genotype_corr", "Treatment", "condition","Phase","Control_spatial_binary","Stroke_spatial_binary", "Pseudotime","Brain_region","nCount_RNA","pseudoaligned_reads", "percent.mt", "percent.rp", "Mouse_ID")
