...
4. [Pipeline Summary](#pipeline-summary)
   - [Step 1 — Annotation Setup](#step-1--annotation-setup)
   - [Step 2 — Data Loading & Metadata](#step-2--data-loading--metadata)
   - [Step 3 — Quality Control & Filtering](#step-3--quality-control--filtering)
   - [Step 4 — Batch Integration](#step-4--batch-integration)
   - [Step 5 — Cell Type Annotation & Microglia Isolation](#step-5--cell-type-annotation--microglia-isolation)
   - [Step 6 — Microglia Reclustering](#step-6--microglia-reclustering)
   - [Step 7 — Cell State Scoring](#step-7--cell-state-scoring)
   - [Step 8 — Differential Gene Expression](#step-8--differential-gene-expression)
   - [Step 9 — Pseudotime Analysis](#step-9--pseudotime-analysis)
   - [Step 10 — WGCNA Co-expression Network Analysis](#step-10--wgcna-co-expression-network-analysis)
   - [Step 11 — Supplementary Visualizations](#step-11--supplementary-visualizations)
5. [Outputs](#outputs)
